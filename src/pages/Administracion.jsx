      ...
      <div className="flex flex-col items-center justify-center gap-12 mt-8">
        <div className="flex gap-8 flex-wrap justify-center">
          ...
          >
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">Carga guías desde archivos Excel.</p>
          </div>
          ...
          >
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">Crea, edita o elimina cuentas del sistema.</p>
          </div>
        </div>
      </div>
    </Layout>
